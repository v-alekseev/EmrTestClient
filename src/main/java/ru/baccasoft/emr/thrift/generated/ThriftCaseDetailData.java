...
public class ThriftCaseDetailData implements org.apache.thrift.TBase<ThriftCaseDetailData, ThriftCaseDetailData._Fields>, java.io.Serializable, Cloneable, Comparable<ThriftCaseDetailData> {
  ...
  private static final org.apache.thrift.protocol.TField PROBLEM_DATA_FIELD_DESC = new org.apache.thrift.protocol.TField("problemData", org.apache.thrift.protocol.TType.STRUCT, (short)3);
  private static final org.apache.thrift.protocol.TField PROCEDURE_DATA_FIELD_DESC = new org.apache.thrift.protocol.TField("procedureData", org.apache.thrift.protocol.TType.STRUCT, (short)4);
  private static final org.apache.thrift.protocol.TField MEDICATION_DATA_FIELD_DESC = new org.apache.thrift.protocol.TField("medicationData", org.apache.thrift.protocol.TType.STRUCT, (short)5);
  ...
  public ThriftSectionProblemData problemData; // required
  public ThriftSectionProcedureData procedureData; // required
  public ThriftSectionMedicationData medicationData; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.MEDICATION_DATA, new org.apache.thrift.meta_data.FieldMetaData("medicationData", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRUCT        , "ThriftSectionMedicationData")));
  ...
  public ThriftCaseDetailData(
    ...
    ThriftSectionProblemData problemData,
    ThriftSectionProcedureData procedureData,
    ThriftSectionMedicationData medicationData)
  {
    this();
    this.caseID = caseID;
  ...
  public ThriftCaseDetailData(ThriftCaseDetailData other) {
    ...
    if (other.isSetProblemData()) {
      this.problemData = new ThriftSectionProblemData(other.problemData);
    }
    if (other.isSetProcedureData()) {
      this.procedureData = new ThriftSectionProcedureData(other.procedureData);
    }
    if (other.isSetMedicationData()) {
      this.medicationData = other.medicationData;
    }
  }
  ...
  public ThriftSectionProblemData getProblemData() {
    return this.problemData;
  }

  public ThriftCaseDetailData setProblemData(ThriftSectionProblemData problemData) {
    this.problemData = problemData;
    return this;
  }
  ...
  public ThriftSectionProcedureData getProcedureData() {
    return this.procedureData;
  }

  public ThriftCaseDetailData setProcedureData(ThriftSectionProcedureData procedureData) {
    this.procedureData = procedureData;
    return this;
  }
  ...
  public ThriftSectionMedicationData getMedicationData() {
    return this.medicationData;
  }

  public ThriftCaseDetailData setMedicationData(ThriftSectionMedicationData medicationData) {
    this.medicationData = medicationData;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case PROBLEM_DATA:
      if (value == null) {
        ...
        setProblemData((ThriftSectionProblemData)value);
      }
      break;
    ...
    case PROCEDURE_DATA:
      if (value == null) {
        ...
        setProcedureData((ThriftSectionProcedureData)value);
      }
      break;
    ...
    case MEDICATION_DATA:
      if (value == null) {
        ...
        setMedicationData((ThriftSectionMedicationData)value);
      }
      break;
  ...
  private static class ThriftCaseDetailDataStandardScheme extends StandardScheme<ThriftCaseDetailData> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, ThriftCaseDetailData struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 3: // PROBLEM_DATA
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.problemData = new ThriftSectionProblemData();
          ...
          case 4: // PROCEDURE_DATA
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.procedureData = new ThriftSectionProcedureData();
          ...
          case 5: // MEDICATION_DATA
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.medicationData = new ThriftSectionMedicationData();
              struct.medicationData.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ThriftCaseDetailData struct) throws org.apache.thrift.TException {
      ...
      if (struct.medicationData != null) {
        ...
        struct.medicationData.write(oprot);
        oprot.writeFieldEnd();
      }
