...
public class ThriftPatientService {
  ...
  public interface Iface {
    ...
    public List<ThriftMedicationData> getPatientMedications(String patientId) throws ThriftException, org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public List<ThriftMedicationData> recv_getPatientMedications() throws ThriftException, org.apache.thrift.TException
    {
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class getPatientMedications<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getPatientMedications_args, List<ThriftMedicationData>> {
      public getPatientMedications() {
        super("getPatientMedications");
      }
      ...
      public void start(I iface, getPatientMedications_args args, org.apache.thrift.async.AsyncMethodCallback<List<ThriftMedicationData>> resultHandler) throws TException {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<ThriftCaseData>(_list0.size);
                  ThriftCaseData _elem1;
                  for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                  {
                    _elem1 = new ThriftCaseData();
                    _elem1.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getPatientCases_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (ThriftCaseData _iter3 : struct.success)
            {
              _iter3.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (ThriftCaseData _iter4 : struct.success)
            {
              _iter4.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<ThriftCaseData>(_list5.size);
            ThriftCaseData _elem6;
            for (int _i7 = 0; _i7 < _list5.size; ++_i7)
            {
              _elem6 = new ThriftCaseData();
              _elem6.read(iprot);
  ...
  public static class getPatientMedications_result implements org.apache.thrift.TBase<getPatientMedications_result, getPatientMedications_result._Fields>, java.io.Serializable, Cloneable, Comparable<getPatientMedications_result>   {
    ...
    public getPatientMedications_result setSuccess(List<ThriftMedicationData> success) {
      this.success = success;
      return this;
    }
    ...
    private static class getPatientMedications_resultStandardScheme extends StandardScheme<getPatientMedications_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<ThriftMedicationData>(_list8.size);
                  ThriftMedicationData _elem9;
                  for (int _i10 = 0; _i10 < _list8.size; ++_i10)
                  {
                    _elem9 = new ThriftMedicationData();
                    _elem9.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getPatientMedications_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.success.size()));
            for (ThriftMedicationData _iter11 : struct.success)
            {
              _iter11.write(oprot);
            }
            oprot.writeListEnd();
    ...
    private static class getPatientMedications_resultTupleScheme extends TupleScheme<getPatientMedications_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, getPatientMedications_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (ThriftMedicationData _iter12 : struct.success)
            {
              _iter12.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<ThriftMedicationData>(_list13.size);
            ThriftMedicationData _elem14;
            for (int _i15 = 0; _i15 < _list13.size; ++_i15)
            {
              _elem14 = new ThriftMedicationData();
              _elem14.read(iprot);
