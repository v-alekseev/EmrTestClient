...
public class ThriftPatientData implements org.apache.thrift.TBase<ThriftPatientData, ThriftPatientData._Fields>, java.io.Serializable, Cloneable, Comparable<ThriftPatientData> {
  ...
  private static final org.apache.thrift.protocol.TField NATIONAL_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("nationalID", org.apache.thrift.protocol.TType.STRING, (short)2);
  ...
  public String nationalID; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    NATIONAL_ID((short)2, "nationalID"),
  ...
  static {
    ...
    tmpMap.put(_Fields.NATIONAL_ID, new org.apache.thrift.meta_data.FieldMetaData("nationalID", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
  ...
  public ThriftPatientData setNationalID(String nationalID) {
    this.nationalID = nationalID;
    return this;
  }

  public void unsetNationalID() {
    this.nationalID = null;
  }

  /** Returns true if field nationalID is set (has been assigned a value) and false otherwise */
  public boolean isSetNationalID() {
    return this.nationalID != null;
  }

  public void setNationalIDIsSet(boolean value) {
    if (!value) {
      this.nationalID = null;
    }
  }
  ...
  public boolean equals(ThriftPatientData that) {
    ...
    boolean this_present_nationalID = true && this.isSetNationalID();
    boolean that_present_nationalID = true && that.isSetNationalID();
    if (this_present_nationalID || that_present_nationalID) {
      if (!(this_present_nationalID && that_present_nationalID))
        return false;
      if (!this.nationalID.equals(that.nationalID))
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_nationalID = true && (isSetNationalID());
    list.add(present_nationalID);
    if (present_nationalID)
      list.add(nationalID);
  ...
  public int compareTo(ThriftPatientData other) {
    ...
    lastComparison = Boolean.valueOf(isSetNationalID()).compareTo(other.isSetNationalID());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNationalID()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.nationalID, other.nationalID);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class ThriftPatientDataStandardScheme extends StandardScheme<ThriftPatientData> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, ThriftPatientData struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 2: // NATIONAL_ID
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.nationalID = iprot.readString();
              struct.setNationalIDIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ThriftPatientData struct) throws org.apache.thrift.TException {
      ...
      if (struct.nationalID != null) {
        oprot.writeFieldBegin(NATIONAL_ID_FIELD_DESC);
        oprot.writeString(struct.nationalID);
        oprot.writeFieldEnd();
      }
