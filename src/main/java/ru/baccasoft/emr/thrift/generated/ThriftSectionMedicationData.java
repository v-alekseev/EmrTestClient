...
public class ThriftSectionMedicationData implements org.apache.thrift.TBase<ThriftSectionMedicationData, ThriftSectionMedicationData._Fields>, java.io.Serializable, Cloneable, Comparable<ThriftSectionMedicationData> {
  ...
  private static final org.apache.thrift.protocol.TField MEDICATION_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("medicationID", org.apache.thrift.protocol.TType.STRING, (short)1);
  ...
  private static final org.apache.thrift.protocol.TField CASE_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("caseID", org.apache.thrift.protocol.TType.STRING, (short)3);
  private static final org.apache.thrift.protocol.TField E_PRESCRIPTION_N_FIELD_DESC = new org.apache.thrift.protocol.TField("ePrescriptionN", org.apache.thrift.protocol.TType.STRING, (short)4);
  private static final org.apache.thrift.protocol.TField DRUG_FIELD_DESC = new org.apache.thrift.protocol.TField("drug", org.apache.thrift.protocol.TType.STRING, (short)5);
  private static final org.apache.thrift.protocol.TField ACTIVE_SUBSTANCE_FIELD_DESC = new org.apache.thrift.protocol.TField("activeSubstance", org.apache.thrift.protocol.TType.STRING, (short)6);
  private static final org.apache.thrift.protocol.TField DOSE_FIELD_DESC = new org.apache.thrift.protocol.TField("dose", org.apache.thrift.protocol.TType.STRING, (short)7);
  ...
  private static final org.apache.thrift.protocol.TField INSTRUCTIONS_FIELD_DESC = new org.apache.thrift.protocol.TField("instructions", org.apache.thrift.protocol.TType.STRING, (short)11);
  ...
  public String medicationID; // required
  ...
  public String activeSubstance; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    MEDICATION_ID((short)1, "medicationID"),
    PATIENT_ID((short)2, "patientID"),
    CASE_ID((short)3, "caseID"),
    E_PRESCRIPTION_N((short)4, "ePrescriptionN"),
    DRUG((short)5, "drug"),
    ACTIVE_SUBSTANCE((short)6, "activeSubstance"),
    DOSE((short)7, "dose"),
    START_DATE((short)8, "startDate"),
    END_DATE((short)9, "endDate"),
    STATUS((short)10, "status"),
    INSTRUCTIONS((short)11, "instructions");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        case 1: // MEDICATION_ID
          return MEDICATION_ID;
        case 2: // PATIENT_ID
          return PATIENT_ID;
        case 3: // CASE_ID
          return CASE_ID;
        case 4: // E_PRESCRIPTION_N
          return E_PRESCRIPTION_N;
        case 5: // DRUG
          return DRUG;
        case 6: // ACTIVE_SUBSTANCE
  ...
  static {
    ...
    tmpMap.put(_Fields.MEDICATION_ID, new org.apache.thrift.meta_data.FieldMetaData("medicationID", org.apache.thrift.TFieldRequirementType.DEFAULT, 
    ...
    tmpMap.put(_Fields.DRUG, new org.apache.thrift.meta_data.FieldMetaData("drug", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.ACTIVE_SUBSTANCE, new org.apache.thrift.meta_data.FieldMetaData("activeSubstance", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
  ...
  public ThriftSectionMedicationData(ThriftSectionMedicationData other) {
    if (other.isSetMedicationID()) {
      this.medicationID = other.medicationID;
    }
  ...
  public ThriftSectionMedicationData setMedicationID(String medicationID) {
    this.medicationID = medicationID;
    return this;
  }
  ...
  /** Returns true if field medicationID is set (has been assigned a value) and false otherwise */
  public boolean isSetMedicationID() {
    return this.medicationID != null;
  }

  public void setMedicationIDIsSet(boolean value) {
    if (!value) {
      this.medicationID = null;
    }
  }
  ...
  public ThriftSectionMedicationData setActiveSubstance(String activeSubstance) {
    this.activeSubstance = activeSubstance;
    return this;
  }

  public void unsetActiveSubstance() {
    this.activeSubstance = null;
  }

  /** Returns true if field activeSubstance is set (has been assigned a value) and false otherwise */
  public boolean isSetActiveSubstance() {
    return this.activeSubstance != null;
  }

  public void setActiveSubstanceIsSet(boolean value) {
    if (!value) {
      this.activeSubstance = null;
    }
  }
  ...
  public ThriftSectionMedicationData setDose(String dose) {
    this.dose = dose;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case ACTIVE_SUBSTANCE:
      if (value == null) {
        unsetActiveSubstance();
      } else {
        setActiveSubstance((String)value);
      }
      break;
  ...
  public boolean equals(ThriftSectionMedicationData that) {
    ...
    boolean this_present_medicationID = true && this.isSetMedicationID();
    boolean that_present_medicationID = true && that.isSetMedicationID();
    if (this_present_medicationID || that_present_medicationID) {
      if (!(this_present_medicationID && that_present_medicationID))
        return false;
      if (!this.medicationID.equals(that.medicationID))
        return false;
    }
    ...
    boolean this_present_activeSubstance = true && this.isSetActiveSubstance();
    boolean that_present_activeSubstance = true && that.isSetActiveSubstance();
    if (this_present_activeSubstance || that_present_activeSubstance) {
      if (!(this_present_activeSubstance && that_present_activeSubstance))
        return false;
      if (!this.activeSubstance.equals(that.activeSubstance))
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_medicationID = true && (isSetMedicationID());
    list.add(present_medicationID);
    if (present_medicationID)
      list.add(medicationID);
    ...
    boolean present_activeSubstance = true && (isSetActiveSubstance());
    list.add(present_activeSubstance);
    if (present_activeSubstance)
      list.add(activeSubstance);
  ...
  public int compareTo(ThriftSectionMedicationData other) {
    ...
    lastComparison = Boolean.valueOf(isSetMedicationID()).compareTo(other.isSetMedicationID());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMedicationID()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.medicationID, other.medicationID);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    lastComparison = Boolean.valueOf(isSetActiveSubstance()).compareTo(other.isSetActiveSubstance());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetActiveSubstance()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.activeSubstance, other.activeSubstance);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    if (this.activeSubstance == null) {
      ...
      sb.append(this.activeSubstance);
    }
    first = false;
    if (!first) sb.append(", ");
    sb.append("dose:");
  ...
  private static class ThriftSectionMedicationDataStandardScheme extends StandardScheme<ThriftSectionMedicationData> {
        ...
        switch (schemeField.id) {
          case 1: // MEDICATION_ID
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.medicationID = iprot.readString();
              struct.setMedicationIDIsSet(true);
            } else { 
          ...
          case 6: // ACTIVE_SUBSTANCE
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.activeSubstance = iprot.readString();
              struct.setActiveSubstanceIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ThriftSectionMedicationData struct) throws org.apache.thrift.TException {
      ...
      if (struct.medicationID != null) {
        oprot.writeFieldBegin(MEDICATION_ID_FIELD_DESC);
        oprot.writeString(struct.medicationID);
        oprot.writeFieldEnd();
      }
      ...
      if (struct.activeSubstance != null) {
        oprot.writeFieldBegin(ACTIVE_SUBSTANCE_FIELD_DESC);
        oprot.writeString(struct.activeSubstance);
        oprot.writeFieldEnd();
      }
      if (struct.dose != null) {
  ...
  private static class ThriftSectionMedicationDataTupleScheme extends TupleScheme<ThriftSectionMedicationData> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, ThriftSectionMedicationData struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetActiveSubstance()) {
        optionals.set(5);
      }
      if (struct.isSetDose()) {
        optionals.set(6);
